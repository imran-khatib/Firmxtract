...
def create_session(config: FirmXtractConfig | None = None) -> Session:
    ...
    # Wire session-scoped logging (plain text + JSON log files)
    from firmxtract.utils.logger import setup_session_logging, set_session_id
    set_session_id(session_id)
    setup_session_logging(output_dir)
